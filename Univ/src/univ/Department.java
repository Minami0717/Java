...
//					table.clearSelection();
		...
		inputBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result != 0) {
					JOptionPane.showMessageDialog(null, dCodeField.getText()+"의 학과 정보가 등록되었습니다.");
					getListAll();
					reset();
				}
			}
		...
		editBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result != 0) {
					JOptionPane.showMessageDialog(null, dCode+"의 학과 정보를 수정했습니다.");
					getListAll();
					reset();
					selectRow = -1;
				}
		...
		delBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int i = JOptionPane.showConfirmDialog(null, dCode+"의 학과 정보를 삭제하시겠습니까?", "삭제", JOptionPane.YES_NO_OPTION);
				
				if (i == 0) {
					int result = delete(dCode);
					
					if (result != 0) {
						JOptionPane.showMessageDialog(null, dCode+"의 학과 정보를 삭제했습니다.");
						getListAll();
						reset();
						selectRow = -1;
					}

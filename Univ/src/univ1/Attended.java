...
public class Attended extends JFrame {
	...
	JTextField dCodeField, dNameField, mNameField, search1Field, search2Field;
	JComboBox sBox;
...
//		ImageIcon cImageIcon = new ImageIcon(cImg);
		...
		sTable.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				selectRow = sTable.getSelectedRow();
				
				dCodeField.setText(sTable.getValueAt(selectRow, 0).toString());
				dNameField.setText(sTable.getValueAt(selectRow, 1).toString());
				mNameField.setText(sTable.getValueAt(selectRow, 2).toString());

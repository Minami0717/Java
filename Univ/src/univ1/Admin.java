...
//					table.clearSelection();
		...
		inputBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (pwCheck == false) {
					JOptionPane.showMessageDialog(null, "PW 중복확인이 필요합니다.");
					pwBtn.requestFocus();
					return;
				}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (dtm.getRowCount() != 0) {
					for (int i = 0; i < table.getRowCount(); i++) {
						if (i != selectRow && idField.getText().equals(table.getValueAt(i, 0))) {
							JOptionPane.showMessageDialog(null, "같은 아이디가 있습니다.");
							return;
						}
					}
				}
